# Generated by Powerlevel10k configuration wizard on 2025-02-17 at 11:20 CET.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 57571.
# Wizard options: nerdfont-v3 + powerline, small icons, rainbow, unicode, 24h time,
# round separators, blurred heads, blurred tails, 2 lines, dotted, right frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=30
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=37
  ...
  typeset -g POWERLEVEL9K_PUBLIC_IP_BACKGROUND=30
  # Custom icon.
