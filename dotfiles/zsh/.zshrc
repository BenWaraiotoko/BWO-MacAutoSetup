...
# Plugins based on installed tools from Brewfile
plugins=(
  # Version Control
  ...
  # Development Tools
  docker                 # Docker aliases and completions (for OrbStack)
  kubectl                # Kubernetes completions
  aws                    # AWS CLI completions

  # Language Support
  python                 # Python aliases and virtualenv
  pip                    # Pip completions
  ...
  vi-mode                # Vi key bindings in shell (optional - can be disabled)
  ...
  # Quality of Life
  aliases                # Show aliases with 'acs' command
  colored-man-pages      # Colorize man pages
  command-not-found      # Suggest packages to install
  copybuffer             # Ctrl+O to copy current command to clipboard
  copyfile               # Copy file contents to clipboard
  copypath               # Copy current path to clipboard
  dirhistory             # Alt+arrows to navigate directory history
  extract                # 'x' command to extract any archive
  sudo                   # Double ESC to add sudo to command
  web-search             # Search web from terminal (google, ddg, etc.)
)
